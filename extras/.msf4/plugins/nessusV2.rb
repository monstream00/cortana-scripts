...
module Msf
	class Plugin::NessusV2 < Msf::Plugin
		...
		class ConsoleCommandDispatcher
			...
			def commands
				{
					...
					"nessus_scan_new_allinone" => "Create new Nessus Scan and Auto Import.",
			...
			def cmd_nessus_help(*args)
				...
				tbl << [ "nessus_scan_new_allinone", "Create new Nessus Scan and Auto Import" ]
			...
			def cmd_nessus_scan_new_allinone(*args)

				if args[0] == "-h"
					print_status("Usage: ")
					print_status("       nessus_scan_new_allinone <policy id> <scan name> <targets>")
					print_status(" Example:> nessus_scan_new_allinone 1 \"My Scan\" 192.168.1.250")
					print_status()
